        ...
        <div className="cavani_tm_contact w-full h-auto clear-both float-left mb-[100px]">
          ...
          <div className="short_info w-full h-auto clear-both float-left mt-[62px]">
            <ul className="ml-[-30px] flex flex-wrap">
              <li className="mb-[30px] w-1/2 pl-[30px]">
                <div className="list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.07)] border text-center py-[32px] px-[25px]">
                  <img
                    ...
                    alt="image"
                  />
                  <span className="block">Cours Mirabeau, Aix-en-provence, FRANCE</span>
                </div>
              </li>
              <li className="mb-[30px] w-1/2 pl-[30px]">
                <div className="list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.07)] border text-center py-[32px] px-[25px]">
                  ...
                  <span className="block">
                    <a
                      ...
                      href="mailto:louis.grellet@gmail.com"
                    >
                ...
                <div className="mapouter">
                  <div className="gmap_canvas">
                    <iframe
                      ...
                      height={355}
                      id="gmap_canvas"
                      src="https://maps.google.com/maps?q=15%20cours%20mirabeau%20aix%20en%20provence&t=&z=15&ie=UTF8&iwloc=&output=embed"
                      frameBorder={0}
                      scrolling="no"
                      marginHeight={0}
                      marginWidth={0}
